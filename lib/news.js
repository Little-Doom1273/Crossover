...
// Some outlets (The Guardian and Sky Sports among them) reject requests
// from unrecognized clients -- a custom User-Agent like
// "CrossoverSportsNews/1.0" gets filtered as an unknown bot, and the
// feed silently returns nothing. Identifying as a standard browser is
// the conventional fix for fetching public RSS feeds.
const FEED_HEADERS = {
  "User-Agent":
...
async function fetchFeed({ name, url, linkMustInclude }) {
  try {
